...
import { SheetSymbolGridBlockBP } from './SheetSymbolGridBlockBP';

export type SheetSymbolGridBlockProps = {
  bp: SheetSymbolGridBlockBP;
};

const SheetSymbolGridBlock: React.FC<SheetSymbolGridBlockProps> = ({ bp }) => {
  ...
  if (
    ...
    throw new Error('SheetSymbolGridBlock can only be used with sheet docs.');
  }
  ...
  return (
    <DocEditorSheetBlock
      blockId={bp.id}
      blockType={'SheetSymbolGridBlock'}
...
export default SheetSymbolGridBlock;
