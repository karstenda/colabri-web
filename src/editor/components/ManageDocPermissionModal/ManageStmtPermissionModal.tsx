...
export type ManageStmtPermissionModalPayload = {
  docName: string;
  loroDoc: StmtLoroDoc;
};

export interface ManageStmtPermissionModalProps
  extends DialogProps<
    ManageStmtPermissionModalPayload,
    Record<Permission, string[]> | null
  > {}
const ManageStmtPermissionModal = ({
  open,
  payload,
  onClose,
}: ManageStmtPermissionModalProps) => {
  // Extract the payload
        ...
        <Box sx={{ pt: 2 }}>
          <PermissionEditor
            permissions={{
              ...
              [t('permissions.sections.language')]: new Set<Permission>([
                Permission.Edit,
                Permission.Approve,
              ]),
            }}
...
export default ManageStmtPermissionModal;
